...
Tämän jälkeen vielä tein pkg tiedoston samaan `init.sls` tiedostoon: https://docs.saltproject.io/en/master/ref/states/all/salt.states.pkg.html#module-salt.states.pkg täältä saaduilla tiedolla ja tallensin sen ctrl x + y enter.
...
Service komento oli kuitenkin epäonnistunut. Ajattelin kokeilla vaihtaa koodia `init.sls` tiedoston sisään ja lisäsin "openvpn" tilalle "apache2" ja kirjoitin service.running: []

<img width="1386" height="1262" alt="image" src="https://github.com/user-attachments/assets/343b4a7c-47e7-47d6-8142-8fcdfb67eb79" />

Tämä toimi! Kokeilin vielä kerran saman komennon jolla pystyin todistamaan idempotenssin.

<img width="125" height="63" alt="image" src="https://github.com/user-attachments/assets/d0ac9728-6d1e-4931-ba8c-4297159c588a" />

Lopputuloksena ei enään tullut muutoksia joten komento oli onnistunut, mutta mitään ei muuttunut. 

### Koodi tehtävät oli huomattavasti vaativampia ja aikaa kulu miettimiseen entistä enemmän. Kuitenkin lopputulokset olivat onnistuneet, joten taisin oppia aika paljonkin uutta. Tehtävää tein iltaan asti, mutta taukoja oli pakko pitää tehtävien välissä. 
...
salt.states.service https://docs.saltproject.io/en/master/ref/states/all/salt.states.service.html
